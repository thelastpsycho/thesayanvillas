    ...
    <>
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-warm-white">
        <div className="max-w-6xl mx-auto">
          <ScrollAnimation {...animationPresets.sectionFadeUp} delay={0}>
            <h2 className="font-calligraphy text-4xl font-light text-charcoal text-center mb-8">
              Villa Amenities
            </h2>
          </ScrollAnimation>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 lg:gap-6">
            <ScrollAnimation {...animationPresets.sectionFadeUp} delay={100}>
              <div className="text-center">
                <div className="w-12 h-12 bg-muted-gold/20 rounded-full flex items-center justify-center mx-auto mb-3">
            ...
            <ScrollAnimation {...animationPresets.sectionFadeUp} delay={600}>
              <div className="text-center">
                <div className="w-12 h-12 bg-muted-gold/20 rounded-full flex items-center justify-center mx-auto mb-3">
                  <svg className="w-6 h-6 text-muted-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
